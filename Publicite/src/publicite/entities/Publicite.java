...
public class Publicite {
   ...
   private String imagePublicite ;
    ...
    public Publicite(String videoPublicite, String genre, int ageMax, int ageMin, int utilisateurID, String lienPublicite, int nbrClick, int nbrAffichage, String imagePublicite) {
        this.videoPublicite = videoPublicite;
        this.genre = genre;
        this.ageMax = ageMax;
        this.ageMin = ageMin;
    ...
    public Publicite(int publiciteID, String videoPublicite, String genre, int ageMax, int ageMin, int utilisateurID, String lienPublicite, int nbrClick, int nbrAffichage, String imagePublicite) {
        this.publiciteID = publiciteID;
        this.videoPublicite = videoPublicite;
        this.genre = genre;
        this.ageMax = ageMax;
